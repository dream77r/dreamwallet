...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'app',
      testMatch: ['**/dashboard.spec.ts', '**/transactions.spec.ts', '**/navigation.spec.ts', '**/ai-chat.spec.ts', '**/budgets.spec.ts', '**/goals.spec.ts', '**/import.spec.ts', '**/analytics.spec.ts', '**/forecast.spec.ts', '**/settings.spec.ts', '**/wrapped.spec.ts', '**/achievements.spec.ts', '**/accounts.spec.ts'],
      use: {
